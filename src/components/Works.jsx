      ...
      <div className="relative">
        ...
        <div className="w-full flex">
          <motion.p className="mt-3 text-secondary text-[17px] max-w-3xl leading-[30px]">
            I present a collection of projects that serve as tangible
            demonstrations of my skills and experience. Each project is
            succinctly described, accompanied by links to corresponding code
            repositories and live demos. These examples showcase my proficiency
            in solving intricate problems, navigating diverse technologies, and
            effectively overseeing project management.
          </motion.p>
          <Image
            src={color_sharp}
            alt="color-sharp"
